  ...
  return (
    <section
      className={clsx(
        ...
        featured ? 'order-first bg-gray-700 lg:order-none' : 'bg-white'
      )}
    >
      <h3
        className={clsx(
            ...
            >
              {['Monthly', 'Annually'].map((period) => (
                <RadioGroup.Option
                  ...
                  value={period}
                  className={clsx(
                    'cursor-pointer border border-gray-300 py-[calc(theme(spacing.2)-1px)] px-[calc(theme(spacing.3)-1px)] text-sm text-white outline-2 outline-offset-2 transition-colors hover:border-gray-400',
                    period === 'Monthly'
                      ? 'rounded-l-lg'
                      : '-ml-px rounded-r-lg'
                  )}
