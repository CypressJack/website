...
import logo from '@/images/logos/google-analytics.png';
  ...
  return (
    <div className={clsx('flex flex-col bg-white ', className)} {...props}>
      <div className="flex justify-between px-4 pt-4">
        <MenuIcon className="h-6 w-6 flex-none stroke-gray-900" />
        ...
        <UserIcon className="h-6 w-6 flex-none stroke-gray-900" />
      </div>
      {children}
    </div>
  )
